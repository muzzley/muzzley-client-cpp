// Generated by Flexc++ V1.08.00 on Fri, 13 Feb 2015 19:29:29 +0000

#ifndef muzzleyHTTPLexerBASE_H_INCLUDED
#define muzzleyHTTPLexerBASE_H_INCLUDED
...
public:
    HTTPLexerBase(HTTPLexerBase const &other)             = delete;
    HTTPLexerBase &operator=(HTTPLexerBase const &rhs)    = delete;
...
protected:
    HTTPLexerBase(std::istream &in, std::ostream &out);
    HTTPLexerBase(std::string const &infilename, std::string const &outfilename);
...
inline std::ostream &HTTPLexerBase::out()
{
    return *d_out;
}

inline void HTTPLexerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void HTTPLexerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline bool HTTPLexerBase::atFinalState()
{
    return d_final.notAtBOL.rule != std::numeric_limits<size_t>::max() || 
            (d_atBOL && d_final.atBOL.rule != std::numeric_limits<size_t>::max());
}

inline void HTTPLexerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void HTTPLexerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &HTTPLexerBase::matched() const
{
    return d_matched;
}

inline HTTPLexerBase::StartCondition__ HTTPLexerBase::startCondition() const
{
    return d_startCondition;
}

inline std::string const &HTTPLexerBase::filename() const
{
    return d_filename;
}
...
inline void HTTPLexerBase::leave(int retValue) const
{
    throw static_cast<Leave__>(retValue);
}

inline size_t HTTPLexerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void HTTPLexerBase::more()
{
    d_more = true;
}

inline void HTTPLexerBase::begin(StartCondition__ startCondition)
{
    d_dfaBase__ = 
        s_dfaBase__[static_cast<int>(d_startCondition = startCondition)];
}

inline size_t HTTPLexerBase::state__() const
{
    return d_state;
}

inline size_t HTTPLexerBase::get__()
{
    return d_input.get();
}

inline bool HTTPLexerBase::return__()
{
    return d_return;
}

inline void HTTPLexerBase::noReturn__()
{
    d_return = false;
}
